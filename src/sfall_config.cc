...
bool sfallConfigInit(int argc, char** argv)
{
    ...
    configSetInt(&gSfallConfig, SFALL_CONFIG_MISC_KEY, SFALL_CONFIG_STARTING_GIFT_KEY, 0);
    configSetString(&gSfallConfig, SFALL_CONFIG_MISC_KEY, SFALL_CONFIG_QUIRKS_KEY, "");
